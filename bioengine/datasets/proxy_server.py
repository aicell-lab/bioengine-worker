...
def start_proxy_server(
    ...
    bioengine_datasets_dir = bioengine_workspace_dir / "datasets"
    current_server_file = bioengine_datasets_dir / "bioengine_current_server"
    executable_path = Path(
        os.getenv("MINIO_EXECUTABLE_PATH") or bioengine_datasets_dir / "bin"
    )
    minio_workdir = bioengine_datasets_dir / "s3"
    minio_config_dir = bioengine_datasets_dir / "config"
