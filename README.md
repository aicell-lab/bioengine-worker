...
A prebuilt Docker image is available under `ghcr.io/aicell-lab/bioengine-worker`.
...
```bash
docker run --rm ghcr.io/aicell-lab/bioengine-worker python -m bioengine_worker --help
```
